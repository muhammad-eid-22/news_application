...
import 'package:news_app/features/home/widgets/custom_slider.dart';
import 'package:news_app/features/home/widgets/recommended_news_list_widget.dart';
import 'package:news_app/features/home/widgets/title_header.dart';
                  ...
                  BlocBuilder<HomeCubit, HomeState>(
                    ...
                    builder: (context, state) {
                      ...
                      if (state is RecommendedNewsLoaded) {
                        final articles = state.articlesResponse;
                        return RecommendedNewsListWidget(articles: articles!);
                      }
